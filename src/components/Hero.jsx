...
export default function Hero() {
  return (
    <>
      ...
      <div
        id="home"
        className="relative w-full bg-[url('/grid-pattern.webp')] bg-cover bg-center min-h-[100vh]"
      >
        ...
        <div className="flex justify-center min-h-[100vh]">
          <div
            ...
            style={{ marginTop: "200px", minHeight: "400px" }}
          >
            ...
            <div style={{ minHeight: "50px" }}>
              <p className="mt-4 text-base sm:text-lg text-center justify-center">
                ...
                with <span className="text-[#5e4bf5] font-bold">StartCode</span>
                .
              </p>
            </div>
